...
# Assign the string with an unevaluated formatting character to variable 'joke_evaluation'
joke_evaluation = "Isn't that joke funny?! %r"

# Print "Isn't that joke funny?! False"
...
print w + e # Concatenate two strings with "+" operater
